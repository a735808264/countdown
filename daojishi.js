...
function daojishi(){
	...
	var gaokao=hgaokao();
	var tian=htian();//剩余天
	var g=gaokaonian();//判断距离xx年高考显示什么
	function hpassed(){
		if (a%4==0){
			if (b==1){passed=c}
	...
	document.getElementById("dangqiannian").innerHTML=a;
	document.getElementById("dangqianyue").innerHTML=b;
	document.getElementById("dangqianri").innerHTML=c;
	document.getElementById("dangqianshi").innerHTML=d;
	document.getElementById("dangqianfen").innerHTML=e;
	document.getElementById("dangqianmiao").innerHTML=f;
